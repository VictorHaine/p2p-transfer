...
- Dependabot must keep Vite and build-toolchain dependencies visible in normal dependency review; do not hide Vite/esbuild/Rolldown/Lightning CSS updates in unrelated release changes.
