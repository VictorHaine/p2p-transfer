...
- `package.json`, `pnpm-lock.yaml`, runtime dependency attestation, or installed package metadata no longer agree on `@roamhq/wrtc@0.10.0`, platform prebuilt `@roamhq/wrtc-*@0.10.0`, and `domexception@4.0.0` without an updated review.
