...
async function main() {
  ...
  const protocolVersion = requiredProtocolVersion(parseJsonEvidence(await readText(path.join(root, "conformance", "protocol-v6.json"), MAX_CONFORMANCE_JSON_BYTES), "conformance/protocol-v6.json").protocolVersion);
