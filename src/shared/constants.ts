...
export const BROWSER_BLOB_FALLBACK_PEAK_MEMORY_BUDGET_BYTES = 128 * 1024 * 1024;
export const BROWSER_BLOB_FALLBACK_MAX_BYTES = 32 * 1024 * 1024;
...
export const RECEIVE_QUEUE_MAX_BYTES = DATA_CHANNEL_BUFFER_HIGH * 4;
export const RECEIVE_QUEUE_MAX_MESSAGES = 4096;
...
export const SIGNALING_MAX_CONNECTION_ATTEMPTS_PER_MINUTE = 120;
...
export const RECEIVER_MAX_PREPAIR_ATTEMPTS = 1;
...
export const STATIC_MAX_IN_FLIGHT_BYTES = 64 * 1024 * 1024;
export const STATIC_MAX_REQUESTS_PER_MINUTE = 300;
...
export const TURN_REST_CREDENTIALS_MAX_ISSUES_PER_MINUTE = 20;
