...
- enable private vulnerability reporting; release preflight verifies the GitHub repository's `private-vulnerability-reporting` endpoint reports enabled before tagging
